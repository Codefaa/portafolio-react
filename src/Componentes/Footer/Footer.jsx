    ...
    return(
        <footer className='footer-seccion ancho'>
            <nav className='footer-enlaces'>
                ...
                <a className='footer-link' href="https://drive.google.com/file/d/19ycVJMEWCycexR9frL6iiGSDOyvGbbhL/view?usp=sharing" target='_blank' rel="noopener noreferrer" data-texto="CV"><i className="bi bi-file-person-fill"></i></a>
            </nav>
